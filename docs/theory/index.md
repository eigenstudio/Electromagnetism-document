...
## [1. Introduction to the Theory Manual](./01_Introduction_to_the_Theory_Manual.md)
...
## [2. Fundamentals of Electrostatics](./02_Fundamentals_to_Electrostatics.md)
...
## [3. Fundamentals of Magnetostatics](./03_Fundamentals_to_Magnetostatics.md)
...
## [4. Maxwell's Equations and Electromagnetic Field Theory](./04_Maxwells_Equations_and_Electromagnetic_field_theory.md)
...
## [5. Magnetic Vector Potential Formulation](./05_Magnetic_Vector_Potential_Formulation.md)
...
## [6. Electrical Machine Fundamentals](./06_Electrical_machine_fundamental.md)
...
## [7. Motor Geometry and Components](./07_Motor_Geometry_and_Components.md)
### 7.1 Stator
### 7.2 Rotor
### 7.3 Airgap
### 7.4 Shaft
...
## [8. Windings and Electrical Excitation](./08_Winding_And_Excitation.md)
...
## [9. Electromagnetic Materials](./09_Electromagnetic_Materials.md)
### 9.1 Air
...
## [10. Finite Element Formulation for Electromagnetic Analysis](./10_Finite_Element_Formulation_for_Electromagnetic_Analysis.md)
...
## [11. Electromagnetic Governing Equations](./11_Electromagnetic_Governing_Equations.md)
...
## [12. Electromagnetic Simulation Setup](./12_Electromagnetic_Simulation_Setup.md)
...
## [13. Transient Simulation of Rotating Electric Machines](./13_Transient_Simulation_of_Rotating_Electric_Machines.md)
### 13.1 Rotor Motion
...
## [14. Electromagnetic Post-Processing and Performance Evaluation](./14_Electromagnetic_Post_Processing_and_Performance_Evaluation.md)
...
## [15. Benchmark Validation and Numerical Verification](./15_Benchmark_Validation_and_Numerical_Verification.md)
...
## [Symbols, Physical Constants, and References](./Symbols_Physical_Constants_and_References.md)
