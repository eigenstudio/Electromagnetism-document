# Inrunner BLDC Motor Simulation — 3. Solver & Simulation Setup
...
To open the solver workspace: Click **Solver**  in the top toolbar
...
![](attachments/speed_sweep.png)


# STAGE F — Simulation Execution and Progress Monitoring
