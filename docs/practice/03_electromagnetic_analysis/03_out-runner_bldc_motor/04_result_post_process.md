# Outrunner BLDC Motor Simulation — 4. Result & Post-Process
...
| Workflow Stage | Part 1 | Part 2 | Part 3 | Part G–H (Current) |
| :--- | :--- | :--- | :--- | :--- |
| **Section** | Creating Project | Preprocessing & Geometry | Solver & Excitations | **Post-Processing & Reporting** |



# PART G — Post-Processing and Result Visualization
...
## G.3 — View Performance Rectangular Plots
...
3. View the selected graph displayed in the visualization window.
...
# PART H — PDF Report Generation & Summary
