...
Modal validation for a three-dimensional solid square plate with simply supported boundary conditions. This case is intended to validate normal modes analysis using 3D solid elements.
...
![Geometry and boundary condition screen](./figures/nafems-fv52-simply-supported-solid-square-plate-geometry.png)

![Mesh screen](./figures/nafems-fv52-simply-supported-solid-square-plate-mesh.png)

![Mode shape or response plot](./figures/nafems-fv52-simply-supported-solid-square-plate-result.png) -->
