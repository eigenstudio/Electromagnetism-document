...
Modal validation for a free thin square plate. This case is intended to check rigid body modes, repeated eigenvalues, and elastic mode extraction for plate or shell formulations.
...
![Geometry and boundary condition screen](./figures/nafems-fv12-free-thin-square-plate-geometry.png)

![Mesh screen](./figures/nafems-fv12-free-thin-square-plate-mesh.png)

![Mode shape or response plot](./figures/nafems-fv12-free-thin-square-plate-result.png) -->
