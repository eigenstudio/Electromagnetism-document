...
Modal validation for a thin square plate with simply supported edges. This case is intended to validate plate or shell dynamic behavior and frequency prediction under classical support conditions.
...
![Geometry and boundary condition screen](./figures/nafems-fv13-simply-supported-thin-square-plate-geometry.png)

![Mesh screen](./figures/nafems-fv13-simply-supported-thin-square-plate-mesh.png)

![Mode shape or response plot](./figures/nafems-fv13-simply-supported-thin-square-plate-result.png) -->
