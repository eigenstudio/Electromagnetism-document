# Free-free modal analysis of a 3D solid block

## What is the purpose of this validation case?

Modal validation for an unconstrained three-dimensional solid block. This case is intended to verify rigid body modes, elastic modes, mass formulation, and eigenvalue extraction.
...
![Geometry and boundary condition screen](./figures/free-free-modal-analysis-of-a-3d-solid-block-geometry.png)

![Mesh screen](./figures/free-free-modal-analysis-of-a-3d-solid-block-mesh.png)

![Mode shape or response plot](./figures/free-free-modal-analysis-of-a-3d-solid-block-result.png) -->
